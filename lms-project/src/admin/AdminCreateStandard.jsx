...
const AdminCreateStandard = ({
  ...
  const { data: existingData, isLoading: isFetching } = useGetStandardByIdQuery(
    standardSubjectId,
    {
      ...
      setFormData({
        ...
        pricing: {
          ...
          discount: {
            ...
            appliesTo: data.discount?.appliesTo || "",
          },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Validate discount appliesTo
      if (
        formData.pricing.discount.type &&
        !formData.pricing.discount.appliesTo
      ) {
        toast.error("Please select where the discount applies");
        setLoading(false);
        return;
      }
      ...
      if (formData.pricing.discount.type) {
        ...
        submitFormData.append(
          "pricing[discount][appliesTo]",
          formData.pricing.discount.appliesTo || "yearly",
        );
      }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {formData.pricing.discount.type && (
                  <div>
                    ...
                    <select
                      name="pricing.discount.appliesTo"
                      value={formData.pricing.discount.appliesTo}
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-600 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      required
                    >
...
export default AdminCreateStandard;
