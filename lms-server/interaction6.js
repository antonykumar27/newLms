...
const StudentCompleteprogress = require("../models/studentCompleteProgress.js");
const quizAttempts = require("./models/quizAttempt.js");
...
const DailyActivity = require("./models/dailyActivitySchema.js");
const mongoose = require("mongoose");
const { saveWatchTime } = require("./studentDashBoard/saveStudentWatchTime.js");
// ==============================================
...
const updateUserProgress = async (
  ...
  try {
    ...
    console.log("prrrrrrrrrrrrrrrrr", progress);
    await progress.save();
  } catch (error) {
